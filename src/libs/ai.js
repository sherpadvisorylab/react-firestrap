import {getPromptLang, getPromptStyle, getPromptVoice, PROMPTS, PROMPTS_ROLE} from "../../conf/Prompt.js";
import {fetchRest} from "./fetch.js";
...
const CHATGPT_APYKEY = process.env.REACT_APP_CHATGPT_APYKEY;
...
const GEMINI_APYKEY = process.env.REACT_APP_GEMINI_APIKEY;
...
const fetchGeminiApi = async (search, strategy, {limit = 10, keywords = [], model = null, framework = null, temperature = null, voice = null, style = null}) => {
    ...
    return fetchRest(`${GEMINI_COMPLETION_URL}?model=${model || GEMINI_MODEL}`, {
        ...
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + GEMINI_APYKEY
        },
        body: body
    })
